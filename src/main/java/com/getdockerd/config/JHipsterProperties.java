...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "getdockerd@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "getdockerd API";

        private String description = "getdockerd API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "getdockerd";
